...
global.github=process.env.GITHUB|| "https://github.com/Pearl Scarlett/Suhail-Md";
...
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "2348035107573";
...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "234xxxxxxxx,234xxxxxxxx";
...
module.exports = {
  ...
  ownername:process.env.OWNER_NAME|| "pearlscalett",
  ...
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : "Pearl Scarlett",
